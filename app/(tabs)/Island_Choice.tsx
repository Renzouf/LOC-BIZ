...
const Aines = () => {
  ...
  return (
    <View style={styles.Container}>
        ...
        <View>
          <Text style={styles.BadotsText}>Island Choice</Text>
          <Image source={require('../../assets/images/island.png')} style={styles.Image}/>
          <View>
            <TouchableOpacity onPress={() => navigation.navigate('IslandChoice')}>
            ...
            <View style={styles.TextBox}>
              ...
              <View>
                <Text style={styles.BadotsTime}>Sunday: 9:00 AM - 6:00 PM </Text>
                <Text style={styles.BadotsTime}>Monday - Wednesday: 9:00 AM - 8:30 PM</Text>
                <Text style={styles.BadotsTime}>Thursday - Saturday: 8:00 AM - 8:00 PM</Text>
              </View>
              </View>

              <View style={styles.BadotsNumBox}>
                <FontAwesome name='phone' size={30} color='black'/>
                <Text style={styles.BadotsPhone}>+63 997 851 6584</Text>
              </View>

              <View style={styles.BadotsRatingBox}>
                <AntDesign name='star' size={30} color='black'/>
                <Text style={styles.BadotsRating}>4.2/5</Text>
              </View>
