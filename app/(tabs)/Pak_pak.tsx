...
const Aines = () => {
  ...
  const openLocation = () => {
    const latitude = 10.795496516631623;
    const longitude = 122.01998701286689;
    const label = 'Pak-pak'; 
  ...
  return (
    <View style={styles.Container}>
        ...
        <View>
          <Text style={styles.AinesText}>Pak Na Pak</Text>
